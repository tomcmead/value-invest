...
struct IncomeStatementData : private FinancialType
{
...
class IncomeStatement : public FinancialJson
{
public:
    std::vector<int> GetFinancial(FinancialType financial_data_type) override;
private:
    using FinancialJson::FinancialJson; // inherit parent constructor
